...
public partial class PauseMenu : CanvasLayer
{
    ...
    private readonly (string ActionName, string Label, Key DefaultKey, int Column)[] _flightBindings =
    {
        ...
        ("ship_toggle_camera", "View Toggle", Key.C, 2),
    };
    ...
    private HSlider _cockpitLookXSlider = null!;
    private HSlider _cockpitLookYSlider = null!;
    ...
    private Label _cockpitLookXValue = null!;
    private Label _cockpitLookYValue = null!;
    ...
    private CheckBox _cockpitInvertX = null!;
    private CheckBox _cockpitInvertY = null!;
    ...
    public override void _Ready()
    {
        ...
        _flightLookXSlider = GetNode<HSlider>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/LookX/Slider");
        _flightLookYSlider = GetNode<HSlider>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/LookY/Slider");
        _flightLookXValue = GetNode<Label>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/LookX/Value");
        _flightLookYValue = GetNode<Label>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/LookY/Value");
        _flightInvertX = GetNode<CheckBox>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/Inverts/InvertX");
        _flightInvertY = GetNode<CheckBox>("Panel/MarginContainer/Root/Tabs/Flight/OrbitCamera/Inverts/InvertY");
        _cockpitLookXSlider = GetNode<HSlider>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/LookX/Slider");
        _cockpitLookYSlider = GetNode<HSlider>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/LookY/Slider");
        _cockpitLookXValue = GetNode<Label>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/LookX/Value");
        _cockpitLookYValue = GetNode<Label>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/LookY/Value");
        _cockpitInvertX = GetNode<CheckBox>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/Inverts/InvertX");
        _cockpitInvertY = GetNode<CheckBox>("Panel/MarginContainer/Root/Tabs/Flight/CockpitCamera/Inverts/InvertY");
        ...
        _cockpitLookXSlider.ValueChanged += OnCockpitLookXChanged;
        _cockpitLookYSlider.ValueChanged += OnCockpitLookYChanged;
        _cockpitInvertX.Toggled += OnCockpitInvertXToggled;
        _cockpitInvertY.Toggled += OnCockpitInvertYToggled;
    ...
    private void UpdateValueLabels()
    {
        ...
        _cockpitLookXValue.Text = $"{_cockpitLookXSlider.Value:0.0000}";
        _cockpitLookYValue.Text = $"{_cockpitLookYSlider.Value:0.0000}";
